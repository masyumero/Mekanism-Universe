package io.github.masyumero.mekuniverse.datagen;
...
@Mod.EventBusSubscriber(modid = MekanismUniverse.MODID, bus = Mod.EventBusSubscriber.Bus.MOD)
public class MekUniverseDataGenerator {

    private MekUniverseDataGenerator() {
    }

    @SubscribeEvent
    public static void gatherData(GatherDataEvent event) {
        bootstrapConfigs(Mekanism.MODID);
        bootstrapConfigs(MekanismUniverse.MODID);
